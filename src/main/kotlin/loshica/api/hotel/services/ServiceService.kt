...
class ServiceService(
    ...
    override fun create(name: String, price: Int): loshica.api.hotel.models.Service {
        val service = loshica.api.hotel.models.Service(name = name, price = price)
        repository.save(service)
        return service
    }

    override fun change(id: Int, name: String, price: Int): loshica.api.hotel.models.Service {
